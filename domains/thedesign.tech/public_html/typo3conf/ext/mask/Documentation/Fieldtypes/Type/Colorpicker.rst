...
.. figure:: ../../Images/FieldTypes/Colorpicker.svg
   :alt: Colorpicker
   :class: float-left
   :width: 64px
...
.. figure:: ../../Images/FieldTypes/ColorpickerPreview.png
   :alt: Colorpicker field
   :class: with-border
...
See a complete overview of Colorpicker TCA options in the :ref:`official documentation <t3tca:columns-input-renderType-colorpicker>`.
