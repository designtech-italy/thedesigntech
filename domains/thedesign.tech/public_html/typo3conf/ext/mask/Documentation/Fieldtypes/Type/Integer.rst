...
.. figure:: ../../Images/FieldTypes/Integer.svg
   :alt: Integer
   :class: float-left
   :width: 64px
...
.. figure:: ../../Images/FieldTypes/IntegerPreview.png
   :alt: Integer field
   :class: with-border
...
See a complete overview of Integer TCA options in the :ref:`official documentation <t3tca:columns-input-renderType-default>`.
